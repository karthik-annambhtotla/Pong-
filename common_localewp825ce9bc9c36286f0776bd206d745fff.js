...
(window.locales = window.locales || {}).common_locale = {
  ...
  activityHeader: function(d) { return d.activityName + " (" + d.activityDuration + " minutes)"; },
  ...
  freePlayUnchangedFail: function(d) { return "Are you finished? It looks like you haven't finished working on this level yet, are you sure you want to move on? If you choose to continue, this level will be marked as \"In progress\" so you can come back to finish it later."; },
